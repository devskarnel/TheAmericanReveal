...
import { Clock, Eye, Share2, ArrowLeft, Calendar } from 'lucide-react'
import { getAllPublishedArticles, getArticleBySlugDB, getRelatedArticlesDB } from '@/lib/db'
      ...
      <article>
        ...
        <div className="bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8 pb-6 border-b-2 border-brand-red/20">
              <div className="flex items-center gap-3">
                <Image
                  ...
                  width={40}
                  height={40}
                  className="rounded-full border-2 border-brand-red/20"
                />
                <div>
            ...
            {/* Author card */}
            <div className="mt-10">
              <h2 className="text-xs font-black uppercase tracking-[0.18em] text-slate-400 mb-4">About the Author</h2>
          ...
          <div className="bg-cream py-14 border-t border-light-border">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {related.map((a, i) => (
                  <ArticleCard key={a.id} article={a} variant="default" index={i} />
                ))}
              </div>
            </div>
          </div>
