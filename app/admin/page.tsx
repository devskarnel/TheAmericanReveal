...
export default function AdminDashboardPage() {
  ...
  const STATS = [
    ...
    { label: 'Total Views', value: `${(totalViews / 1000000).toFixed(1)}M`, icon: Users, color: 'text-emerald-400', bg: 'bg-emerald-500/10' },
  ]
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-1 text-xs text-ink-700">
                        ...
                        <span>·</span>
                        <span className="flex items-center gap-1"><Eye className="w-3 h-3" />{((article.views ?? 0) / 1000).toFixed(0)}K</span>
                      </div>
                    </div>
